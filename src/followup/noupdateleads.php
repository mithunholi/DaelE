...
?>
             ...
             <tr>  
              ...
              <tr>
              	<td colspan="5" align="left">
                	<input type="button" name="action" value="Apply" onClick="javascript:SearchData(this.form,'followup/noupdateleads.php?a=filter'+'&fromdate='+document.frmListProduct.fromdate.value)" >
					<input type="button" name="action" value="Reset" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=reset')">
               </td>
              </tr>
	...
	<hr size="1" noshade>
    <form name="frmLead" id="frmLead" action="followup/noupdateleads.php?a=del" method="post">
	<table class="bd" border="0" cellspacing="1" cellpadding="4" width="100%">
		<tr>
			
            <td align="right">Rows Per Page
    	     <select name="pageperrecord" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?pageId='+this.value)">
	...
	<table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
    	<tr>
            ...
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "customer_id" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("ID") ?>
                </a>
            </td>
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "customer_name" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Company Name") ?>
                </a>
            </td>
           
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "prod_desc" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Customer Requirement") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "customer_mobno" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Mobile No") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "customer_cperson" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Contact Person") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "lead_book_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Lead Date") ?>
                </a>
            </td>
            <td class="hr">
          	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?order=<?php echo "follow_up_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Follow Up Date") ?>
                </a>
            </td>
			<td class="hr">
	...
	<tr class="<?php echo $style ?>" style="cursor:pointer">
      ...
      <td align="left" width="3%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_id"])) ?>
      </td>
	  <td align="left" width="20%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_name"])) ?>
      </td>
     
      <td align="left" width="30%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo str_replace('<br/>', '\n', nl2br($row["prod_desc"])) ?>
      </td>
	  <td align="left" width="10%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_mobno"])) ?>
      </td>
      <td align="left" width="15%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      ...
      <td align="center" width="5%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
	...
	<?php 
		...
		showpagenav($page, $pagecount,$pagerange,'followup/noupdateleads.php'); 
} 
?></center>
<?php
    	...
    	<tr>
			...
			<td align="left">
				...
				?>
                	...
                	<?php }else{ ?>	
                            <select name="cust_name" id="cust_name" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=add&cust_code='+this.value)">
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?status=true&page=<?php echo $page ?>')"></td>
			<?php 
			if ($recid > 0) 
			{ 
			?>
			<td><input type="button" name="btnPrior" value="Prior Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>')"></td>
			<?php 
			} 
			if ($recid < $count - 1) { ?>
				<td>
                <input type="button" name="btnNext" value="Next Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>')"></td>
	  <?php } ?>
	   </tr>
	</table>
	<hr size="1" noshade>
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php')"></td>
		</tr>
	</table>
	<hr size="1" noshade>
...
?>
    ...
    <form name="frmLead" enctype="multipart/form-data" action="lead/processLead.php?action=update" method="post">
		...
		<table class="bd" border="0" cellspacing="1" cellpadding="4">
			<tr>
				<td>
           			<input type="button" name="btnEdit" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=edit&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>&page=<?php echo $page ?>')" value="Edit Record">
                
            	</td>
				<td>
            		<input type="button" name="btnReject" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?a=reject&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>&page=<?php echo $page ?>')" value="Reject Record">
                    
                
            	</td>
            	<td>
            		<input type="button" name="btnAccept" onClick="javascript:formget(this.form,'lead/processLead.php?action1=accept');javascript:LoadDiv('<?php echo CENTER_DIV ?>','followup/noupdateleads.php?status=true');javascript:printHeader('Lead Admin');" value="Accept Record">
...
function sql_getrecordcount()
{
	...
	if($_SESSION['User_Design']=='ADMIN') {
		...
		$sql = "select count(*) from (select c.prod_desc,b.customer_id, b.customer_name, b.customer_address,b.customer_city,b.customer_country, b.customer_mobno,
				...
				from tbl_customer b,tbl_lead_master c 
				where c.cust_code=b.customer_id and c.lead_book_status='0' and c.reject_status='0' and c.user_id='$uid' 
				and date_format( c.follow_up_date, '%Y-%m-%d' ) < '$fromdate1') subq where 1";
	}
