...
<tr>
	<td colspan="3" valign="top" style=" border-right:solid thin #BFBFBF 1px;" >
		...
		<tr>		
            ...
            <a onClick="javascript:LoadDiv('Center_Content','products/product.php?status=true');javascript:printHeader('Products Admin');" style="text-decoration: none; cursor:pointer">
            <img style="border:none;" src="images/prdlist.jpg" width="117" height="84">
            </a>            
            </th>
            <th height="69" scope="row">
            <a onClick="javascript:LoadDiv('Center_Content','products/productReport.php?status=true');javascript:printHeader('Products List');">
            <img style="border:none;" src="images/prdlist.jpg" width="117" height="84">
            </a>
            </th>            		
		</tr>
		<tr>
          ...
          <a onClick="javascript:LoadDiv('Center_Content','products/product.php?status=true');javascript:printHeader('Products Admin');" style="text-decoration: none;cursor:pointer">Products</a>
          </th>
          <th height="19" scope="row">
          <a onClick="javascript:LoadDiv('Center_Content','products/productReport.php?status=true');javascript:printHeader('Products List');">
          	Products List
