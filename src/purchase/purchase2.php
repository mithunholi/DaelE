...
?>
	<form name="frmListProduct" action="" method="post">
		<table border="0" cellspacing="1" cellpadding="4" width="100%" bgcolor="#EAEAEA">
			<tr>
				...
				<input type="button" name="action" value="Apply" onClick="javascript:SearchData(this.form,'purchase/purchase1.php?a=filter')" >
				<input type="button" name="action" value="Reset" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=reset')">
                </td>
	...
	<hr size="1" noshade>
    <form name="frmProduct" id="frmProduct" action="purchase/purchase1.php?a=del" method="post">
	<table class="bd" border="0" cellspacing="1" cellpadding="4" width="100%">
		<tr>
			<td align="left">
            <input type="button" name="action" value="New Purchase" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=add')">
         
            <input type="button" name="btnPosting" value="Posting"  onClick="if(onPosting()==true){javascript:formget(this.form,'purchase/processPurchase1.php'); javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?status=true');javascript:printHeader('Purchase Admin');}" >
                    <input type="hidden" name="action" value="posting">
            </td>
            <td align="right">Rows Per Page
    	     <select name="pageperrecord" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?pageId='+this.value)">
	...
	<table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
    	<tr>
            ...
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?order=<?php echo "purc_bill_no" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Bill Number") ?>
                </a>
            </td>
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?order=<?php echo "supp_name" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Supplier Name") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?order=<?php echo "purc_net_amt" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Net Amount") ?>
                </a>
            </td>
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?order=<?php echo "purc_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Purchased Date") ?>
                </a>
            </td>
           
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?order=<?php echo "purc_status" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Status") ?>
                </a>
            </td>
	...
	<tr class="<?php echo $style ?>" style="cursor:pointer">
        ...
        <td align="left" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=view&recid=<?php echo $i ?>')">
	...
	<?php 
		...
		showpagenav($page, $pagecount,$pagerange,'purchase/purchase1.php'); 
} 
?></center>
<?php
	...
	<table border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
    	...
    	<tr> 
              ...
              <?php }else{ ?>
                     ...
                     <!--   <option value="new" onClick="javascript:LoadDiv('<?php //echo CENTER_DIV ?>','purchase/purchase1.php?a=suppadd&editmode=<?php //echo $iseditMode; ?>')">New Supplier</option> -->
						<?php
							echo $supplierList;
						?>	 
    				</select>
        	...
        	<td colspan="2">
            	<table width="100%" class="hrhighlightblue">
                	<tr>
                     ...
                     <tr>
                     	<td width="10%"><input type="text" name="partno" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&partno='+this.value+'&purc_billno='+document.products.purc_billno.value+'&suppId='+document.products.cboSupplier.value)" value="<?php echo $partno; ?>" maxlength="10" size="10"></td>
                        <td width="15%">
                        <?php if(isset($catId) && $catId != "" && $catId == 'newCategory'){ ?>
                        	<input type="text" name="cname" id="cname" class="upperclass" size="20" maxlength="20">
                        <?php }else{ ?>
                        	<select name="cname" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&catId='+this.value+'&purc_billno='+document.products.purc_billno.value)">
						...
						?>
                        <td width="10%"><input type="text" name="searchtext" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&searchtext='+this.value+'&purc_billno='+document.products.purc_billno.value)" value="<?php echo $searchtext; ?>" maxlength="10" size="10"></td>
                        <?php } ?>
                        <td width="20%">
                        ...
                        <?php }else{ ?>
                        <select name="pname" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'purchase/purchase1.php?a=<?php echo $a; ?>&pcode='+this.value+'&catId='+document.products.cname.value+'&purc_billno='+document.products.purc_billno.value)">
                  ...
                  <!--  <option value="newProduct">New Product</option> -->
                        ...
                        <td width="5%">
                        <input type="text" name="ptax" value="<?php if($ptax != 0){ echo $ptax; } else { echo '0.00'; }?>" size="10" onChange="javascript:calcTotalAmount(document.products.pdiscount.value,document.products.pqty.value,document.products.pprice.value,this.value)"></td>
                        <td width="5%">
                            <input type="text" name="pdiscount" value="<?php if($pdiscount != 0){ echo $pdiscount; } else { echo '0'; }?>" size="10" onChange="javascript:calcTotalAmount(this.value,document.products.pqty.value,document.products.pprice.value,document.products.ptax.value)"></td>
...
function dataAdd($cc,$pc,$pq,$pr,$pt,$pd){
	...
	$chk_res = mysql_query($chk_qry,$conn);
	if(mysql_num_rows($chk_res)<=0){
		...
		$ins_res = mysql_query($ins_qry,$conn);
	}
}
...
function dataEditRetrieve($pid){
	...
	$editres= mysql_query($editqry,$conn);
	if(mysql_num_rows($editres)>0){
		$tempqry = mysql_query("select * from tbl_temp_product where lead_id='$pid'");
		if(mysql_num_rows($tempqry)<=0){
...
function dataCopy($lid){
	...
	$editres= mysql_query($editqry,$conn);
	if(mysql_num_rows($editres)>0){
		$tempqry = mysql_query("select * from tbl_temp_product where lead_id='$lid'");
		if(mysql_num_rows($tempqry)<=0){
			$qrydata = "insert into tbl_temp_product (lead_id,cat_code,prod_code,prod_qty,prod_price,prod_amount,prod_tax,prod_discount) 
							select purc_id,cat_code,prod_code,prod_qty,prod_price,prod_amount,prod_tax,prod_discount from tbl_purc_child 
							where purc_id='$lid'";
...
function dataEdit($rid,$totamt,$damt){
	...
	$ret_res = mysql_query($ret_qry,$conn);
	if(mysql_num_rows($ret_res)>0){
	?>
    ...
    <?php
		$i=1;
		$totamt = 0;
		while($ret_row= mysql_fetch_assoc($ret_res)){
			$recid= $ret_row["id"];
			...
			echo "<td>";
			?>
            <a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'purchase/purchase1.php?a=<?php echo $a; ?>&recordstatus=updaterecord&recordid=<?php echo $recid; ?>&eqty='+document.products.eprod_qty.value+'&ettax='+document.products.eprod_tax.value+'&etdiscount='+document.products.eprod_discount.value+'&etprice=<?php echo $price; ?>')">Update</a>
			<?php
			echo "</td><td>";
			?>
			<a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'purchase/purchase1.php?a=<?php echo $a; ?>&recordstatus=cancelrecord&recordid=<?php echo $recid; ?>')">Cancel</a>
			<?php
			echo "</td>";
			echo "</tr>";
...
function purchaseRecordRetrieve($pid){
	global $conn;
	global $a;
	$ret_qry= "select b.part_code,c.cat_name,d.prod_name,b.prod_qty,b.prod_price,b.prod_amount,b.prod_tax,b.prod_discount
				from tbl_purc_master a,tbl_purc_child b,tbl_categories c,tbl_product d
				where a.purc_id=b.purc_id and b.cat_code=c.cat_code and b.prod_code = d.prod_code and b.purc_id='$pid'";
...
function dataRet($totamt,$damt){
    ...
    <?php
		...
		while($ret_row= mysql_fetch_assoc($ret_res)){
			...
			?>
            <td align="center">
            <a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&recordstatus=editrecord&recordid=<?php echo $recid; ?>')">Edit</a>
            </td>
            <td align="center">
			<a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&recordstatus=deleterecord&recordid=<?php echo $recid; ?>')">Delete</a>
			</td>
...
?>
   ...
   <p>
   <input type="button" name="btnAdd" id="btnAdd" value="Save" onClick="javascript: formget(this.form, 'purchase/processPurchase.php');javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $edstatus ?>');"></p>
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?status=true')"></td>
			<?php 
			if ($recid > 0) 
			{ 
			?>
			<td><input type="button" name="btnPrior" value="Prior Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>')"></td>
			<?php 
			} 
			if ($recid < $count - 1) { ?>
				<td>
                <input type="button" name="btnNext" value="Next Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>')"></td>
	  <?php } ?>
	   </tr>
	</table>
	<hr size="1" noshade>
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php')"></td>
		</tr>
	</table>
	<hr size="1" noshade>
	<form name="products" enctype="multipart/form-data" action="purchase/processPurchase1.php?action=add" method="post">
		...
		?>
		<p><input type="button" name="btnAdd" id="btnAdd" value="Save" onClick="javascript: formget(this.form, 'purchase/processPurchase1.php');"></p>
...
?>
        ...
        <table class="bd" border="0" cellspacing="1" cellpadding="4">
            <tr>
                <td>
                    <input type="button" name="btnEdit" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=edit&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>')" value="Edit Record">
