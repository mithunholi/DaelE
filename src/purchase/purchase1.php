        	...
        	<td colspan="2">
            	<table width="100%" class="hrhighlightblue">
                	<tr>
                     ...
                     <tr>
                     	<td width="10%"><input type="text" name="partno" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&partno='+this.value+'&purc_billno='+document.products.purc_billno.value+'&suppId='+document.products.cboSupplier.value)" value="<?php echo $partno; ?>" maxlength="8" size="8"></td>
                        <td width="15%">
                        <?php if(isset($catId) && $catId != "" && $catId == 'newCategory'){ ?>
                        	<input type="text" name="cname" id="cname" class="upperclass" size="20" maxlength="20">
                        <?php }else{ ?>
                        	<select name="cname" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','purchase/purchase1.php?a=<?php echo $a; ?>&catId='+this.value+'&purc_billno='+document.products.purc_billno.value+'&suppId='+document.products.cboSupplier.value)">
                        ...
                        <?php }else{ ?>
                        <select name="pname" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'purchase/purchase1.php?a=<?php echo $a; ?>&pcode='+this.value+'&catId='+document.products.cname.value+'&purc_billno='+document.products.purc_billno.value+'&suppId='+document.products.cboSupplier.value)">
...
function dataRet($totamt,$damt){
	...
	?>
    	...
    	<tr>
        	<td colspan="7" align="right">Total Amount</td>
            <td><input type="text" name="txttotalamt" id="txttotalamt" value="<?php echo number_format($totamt,2,'.',','); ?>" readonly align="right"></td>
            <td colspan="2">&nbsp;</td></tr>
    	</table>
    <?php
	}
