...
?>
	...
	<table class="bd" border="0" cellspacing="1" cellpadding="4" width="100%">
		<tr>
			<td align="left">
            <input type="button" name="action" value="Add New Lead" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?cust_code=true&a=add&leadId=<?php echo $leadId ?>')">
	...
	<table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
    	<tr>
            ...
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "customer_id" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("ID") ?>
                </a>
            </td>
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "customer_name" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Company Name") ?>
                </a>
            </td>
           
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "prod_desc" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Customer Requirement") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "customer_mobno" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Mobile No") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "customer_cperson" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Contact Person") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "lead_book_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Lead Date") ?>
                </a>
            </td>
            <td class="hr">
          	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?order=<?php echo "follow_up_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Follow Up Date") ?>
                </a>
            </td>
			<td class="hr">
	...
	<tr class="<?php echo $style ?>" style="cursor:pointer">
      ...
      <td align="left" width="3%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_id"])) ?>
      </td>
	  <td align="left" width="20%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_name"])) ?>
      </td>
     
      <td align="left" width="30%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo str_replace('<br/>', '\n', nl2br($row["prod_desc"])) ?>
      </td>
	  <td align="left" width="10%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      		<?php echo htmlspecialchars(strtoupper($row["customer_mobno"])) ?>
      </td>
      <td align="left" width="15%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
      ...
      <?php
	  	$fdate = date("d-m-Y",strtotime($row["follow_up_date"]));
		$tdate = date("d-m-Y",strtotime($today));

		//echo "Fdate :".$fdate." Today :".$tdate."<br>";
		
		if(strtotime($tdate) > strtotime($fdate)){
			
	  ?>
	  	
      <td align="left" width="15%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')" bgcolor="#EE0000">
      		<?php echo $fdate; ?>
      </td>
      <?php
	    }else if(strtotime($tdate) < strtotime($fdate)){
	  ?>
      	 <td align="left" width="15%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')" 
         			bgcolor="#FFFF33">
      		<?php echo $fdate; ?>
	  ...
	  ?>	
      <td align="center" width="5%" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=view&recid=<?php echo $i ?>&page=<?php echo $page ?>')">
...
?>
	...
	<table  border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
    	<tr>
			...
			<td align="left">
				...
				?>
                	...
                	<?php }else{ ?>	
                            <select name="cust_name" id="cust_name" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=add&cust_code='+this.value)">
        ...
        <tr>
			<td align="left" name="cust_require" valign="top"><?php echo htmlspecialchars("Customer Requirement")."&nbsp;" ?>
            </td>
			<td align="left">
            	<?php 
					if($iseditmode != 1){ ?>
            ...
            <?php 
				if($iseditmode != 1){ 
            		$fupdate = date("Y-m-d");
			 		...
			 		$fupdate = date(($row['follow_up_date']));
			 	} 
			?>
...
?>
	<table border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
		...
		<tr>
			...
			<td align="left"><?php echo date(($row["lead_book_date"])) ?></td>
		</tr>
        ...
        <tr>
			...
			<td align="left"><?php echo date(($row["follow_up_date"])) ?></td>
		</tr>
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?status=true&page=<?php echo $page ?>')"></td>
			<?php 
			if ($recid > 0) 
			{ 
			?>
...
?>
    ...
    <form name="frmLead" enctype="multipart/form-data" action="lead/processLead.php?action=update" method="post">
		...
		<table class="bd" border="0" cellspacing="1" cellpadding="4">
			<tr>
				<td>
           			<input type="button" name="btnEdit" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=edit&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>&page=<?php echo $page ?>')" value="Edit Record">
                
            	</td>
				<td>
            		<input type="button" name="btnReject" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?a=reject&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>&page=<?php echo $page ?>')" value="Reject Record">
                    
                
            	</td>
            	<td>
            		<input type="button" name="btnAccept" onClick="javascript:formget(this.form,'lead/processLead.php?action1=accept');javascript:LoadDiv('<?php echo CENTER_DIV ?>','lead/lead.php?status=true');javascript:printHeader('Lead Admin');" value="Accept Record">
...
function sql_select()
{
	...
	if($_SESSION['User_Design']=='ADMIN') {
  	$sql = "select * from (select c.prod_desc, b.customer_id, b.customer_name, b.customer_address,b.customer_city,b.customer_country, b.customer_mobno,
			...
			where c.cust_code=b.customer_id and c.lead_book_status='0' and c.reject_status='0') subq where 1";
	}else{
	$sql = "select * from (select c.prod_desc, b.customer_id, b.customer_name, b.customer_address,b.customer_city,b.customer_country, b.customer_mobno,
			b.customer_cperson,b.customer_email,b.customer_web,c.lead_book_date, c.ref_by, c.follow_up_date,c.remark,c.lead_id,c.cust_code,c.cust_require 
			from tbl_customer b,tbl_lead_master c 
			where c.cust_code=b.customer_id and c.lead_book_status='0' and c.reject_status='0' and c.user_id='$uid') subq where 1";
	}
