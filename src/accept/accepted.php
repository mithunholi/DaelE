...
?>
	<form name="frmListProduct" action="" method="post">
		<table border="0" cellspacing="1" cellpadding="4" width="100%" bgcolor="#EAEAEA">
			<tr>
				...
				<input type="button" name="action" value="Apply" onClick="javascript:SearchData(this.form,'accept/accepted.php?a=filter')" >
				<input type="button" name="action" value="Reset" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=reset')">
                </td>
	...
	<hr size="1" noshade>
    <form name="frmLead" id="frmLead" action="accept/accepted.php?a=del" method="post">
	<table class="bd" border="0" cellspacing="1" cellpadding="4" width="100%">
		<tr>
			
            <td align="right">Rows Per Page
    	     <select name="pageperrecord" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?pageId='+this.value)">
	...
	<table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
    	<tr>
			...
			<td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?order=<?php echo "customer_name" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Company Name") ?>
                </a>
            </td>
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?order=<?php echo "lead_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Lead Date") ?>
                </a>
            </td>
			
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?order=<?php echo "quot_id" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Quote No") ?>
                </a>
            </td>
            
            <td class="hr">
            	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?order=<?php echo "proposal_quote_date" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Quote Date") ?>
                </a>
            </td>
            
            <td class="hr">
          	<a class="hr" href="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?order=<?php echo "total_amt" ?>&type=<?php echo $ordtypestr ?>')">
					<?php echo htmlspecialchars("Quote Amount") ?>
                </a>
            </td>
	...
	<tr class="<?php echo $style ?>" style="cursor:pointer">
	  ...
	  <td align="left" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=view&recid=<?php echo $i ?>')">
      ...
      <td align="left" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=view&recid=<?php echo $i ?>')">
      		<?php 
					...
					echo number_format($row["total_amt"],2,".",","); 
	...
	<?php 
		...
		showpagenav($page, $pagecount,$pagerange,'accept/accepted.php'); 
} 
?></center>
<?php
...
function showroweditor($row, $iseditmode)
{
 ...
 // if($leadId==0){
  ...
  if($cmbinstype != "" and $cmbinstype != "0"){
  	$installationNumber = $cmbinstype;
  }
  $installationList = buildInstallationList($installationNumber);
...
?>
	...
	<table border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
		...
		<table  border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
        <?php 
			if(paymentdataFound($leadid,$quoteid)){	
		?>
        	<tr>
            	<td colspan="2">
                	<?php dataRetrieve($leadid,$quoteid); ?>
                </td>
            </tr>
         <?php 
		 	}
		 ?>
           ...
           <tr>
                ...
                <td align="left">
                	<select name="cmbpaymethod" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=edit&cmbpaytype='+document.frmLead.cmbpaytype.value+'&cmbpaymethod='+this.value)">
                    	<option value="">--Choose Any One--</option>
          ...
          <tr>     
                ...
                <td align="left"><input type="text" name="paymentnumber" size="30" maxlength="30" value="<?php $paymentnumber; ?>"></td>
          </tr>
          <tr>     
                <td align="left" width="15%">Bank Information</td>
                <td align="left">
                	<?php if($row["bank_info"] != "") { ?>
                    <textarea name="bankinfo" rows="3" cols="45"><?=$row["bank_info"]?></textarea>
                    <?php }else{ ?> 
		...
		<table  border="0" cellspacing="1" cellpadding="5" width="100%" class="hrhighlightblue">
        	<tr>
                ...
                <td align="left">
                	<?php if($cmbinstype=="newinstype"){ ?>
                    <input type="text" name="cmbinstype" size="30" maxlength="30">
                    <?php }else{ ?>
                	<select name="cmbinstype" onChange="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=edit&cmbinstype='+this.value+'&cmbpaytype='+document.frmLead.cmbpaytype.value+'&cmbpaymethod='+document.frmLead.cmbpaymethod.value+'&paymentamount='+document.frmLead.paymentamount.value+'&paymentdate='+document.frmLead.paymentdate.value+'&paymentnumber='+document.frmLead.paymentnumber.value)">
                    	<option value="">--Choose Any One--</option>
                        <option value="newinstype">New Task</option>
                        <?php $installationList; ?>
                    </select><?php echo htmlspecialchars("*")."&nbsp;" ?>
                    <?php } ?>
               </td>
           </tr>
           <tr>
           		<td align="left" width="15%">Task Description</td>
                <td align="left">
                	<textarea name="txtsummary" cols="45" rows="5"></textarea><?php echo htmlspecialchars("*")."&nbsp;" ?>
                </td>
           </tr>    
        </table>
        </div>
...
function dataEdit($rid,$totamt,$damt){
    ...
    <?php
		...
		while($ret_row= mysql_fetch_assoc($ret_res)){
			...
			echo "<td>";
			?>
            <a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'accept/accepted.php?a=edit&recordstatus=updaterecord&recordid=<?php echo $recid; ?>&eqty='+document.frmLead.eprod_qty.value+'&ettax='+document.frmLead.eprod_tax.value+'&etdiscount='+document.frmLead.eprod_discount.value+'&etprice=<?php echo $price; ?>')">Update</a>
			<?php
			echo "</td><td>";
			?>
			<a href="javascript:LoadDiv('<?php echo CENTER_DIV ?>', 'accept/accepted.php?a=edit&recordstatus=cancelrecord&recordid=<?php echo $recid; ?>')">Cancel</a>
			<?php
			echo "</td>";
			echo "</tr>";
...
function dataRetrieve($lid,$qid){
	global $conn;
	$ret_qry= "select b.id,b.pay_type,b.pay_method,b.paid_amount,b.pay_date
				from tbl_lead_master a,tbl_lead_payment b
				where a.lead_id=b.lead_id and a.quot_id=b.quot_id and b.lead_id='$lid' and b.quot_id='$qid'";
	$ret_res = mysql_query($ret_qry,$conn);
	if(mysql_num_rows($ret_res)>0){
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?status=true')"></td>
			<?php 
			if ($recid > 0) 
			{ 
			?>
			<td><input type="button" name="btnPrior" value="Prior Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>')"></td>
			<?php 
			} 
			if ($recid < $count - 1) { ?>
				<td>
                <input type="button" name="btnNext" value="Next Record" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>')"></td>
	  <?php } ?>
	   </tr>
	</table>
	<hr size="1" noshade>
...
?>
	<table class="bd" border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php')"></td>
		</tr>
	</table>
	<hr size="1" noshade>
...
?>
	<br>
    <form name="frmLead" enctype="multipart/form-data" action="accept/processAccept.php?action=update" method="post">
		...
		<table class="bd" border="0" cellspacing="1" cellpadding="4">
			<tr>
				<td>
           			<input type="button" name="btnEdit" onClick="javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?a=edit&filter=<?php echo $prodcode ?>&filter_field=<?php echo $field ?>')" value="Edit Record">
                
            	</td>
				<td>
            		<input type="button" name="btnReject" onClick="javascript:formget(this.form,'proposal/processProposal.php?action1=reject');javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?status=true');javascript:printHeader('Lead Admin');" value="Reject Record">
                
            	</td>
            	<td>
            		<input type="button" name="btnAccept" onClick="javascript:formget(this.form,'proposal/processProposal.php?action1=accept');javascript:LoadDiv('<?php echo CENTER_DIV ?>','accept/accepted.php?status=true');javascript:printHeader('Lead Admin');" value="Accept Record">
...
?>
	...
	<form name="frmLead" enctype="multipart/form-data" action="accept/processAccept.php?action=update" method="post">
		...
		<p>
        <input type="button" name="btnedit" id="btnedit" value="Update" onClick="javascript: formget(this.form, 'accept/processAccept.php');">
        </p>
        <div id="output" style="color: blue;"></div>
...
?>
	<br>
	<form name="frmLead" action="accept/processAccept.php?action=delete" method="post">
...
function sql_select()
{
	...
	if($_SESSION['User_Design']=='ADMIN') {
		...
		$sql = "select * from (select c.prod_desc, b.customer_name, b.customer_address,b.customer_city,b.customer_country, b.customer_mobno,
				...
				c.total_amt,c.discount_amt,c.remark 
